# Introduction to Phylogenetics & Phylogenomics
...
These materials are released under a [CC BY 4.0](LICENSE.md) license.This repository contains the materials for the course.
